...
class Experience extends Component {
  ...
  //       }
  //       console.log("PDF creation successful, now fetching the PDF...");
  
  //       return fetch("fetch-pdf", {
  //         method: "GET",
  //         headers: {
  ...
  //       }
  //       return response.arrayBuffer(); // Read the response as arrayBuffer for binary data
  //     })
  //     .then((data) => {
